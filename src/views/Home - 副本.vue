  ...
  <el-container>
    ...
    <el-header>
      <div>
        ...
        <div>
          <span style="font-weight: 100; margin: 0 10px; font-size: 14px;">{{userinfo.username}}</span>
          <span  style="font-weight: 100; margin: 0 10px; font-size: 14px;">{{userinfo. mobile}}</span>
